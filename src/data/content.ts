...
const calliOverride: Record<string, string> = {
  ...
  'Avisos legales': 'Avisos',
};
export function calliTitle(s: string): string {
  const word = calliOverride[s] ?? s.split(' ').pop()!;
  const i = s.indexOf(word);
  if (i < 0) return s;
  return s.slice(0, i) + '<span class="calli">' + word + '</span>' + s.slice(i + word.length);
}
...
export const t = {
  ca: {
    ...
    pages: {
      ...
      prices: {
        title: 'Tarifes', subtitle: 'Preus clars i sense sorpreses.', note: 'Primera classe de pilates gratuïta.',
        insurance: {
          title: 'Tens una mútua amb reemborsament?',
          subtitle: 'Recupera fins al 80% del cost de la teva sessió de fisioteràpia.',
          p1: 'A la nostra clínica no treballem directament amb mútues, perquè això ens permet dedicar el temps necessari a cada pacient i oferir un tractament totalment personalitzat.',
          p2: 'Ara bé, si la teva pòlissa inclou reemborsament de despeses o lliure elecció de professionals, és molt probable que la teva asseguradora et retorni entre el 60% i el 80% del cost de la sessió (segons les condicions de la teva mútua).',
          stepsTitle: 'Com funciona?',
          steps: [
            { title: 'Comprova la teva pòlissa', text: 'Contacta amb la teva mútua i confirma que disposes de cobertura amb reemborsament o lliure elecció de professionals.' },
            { title: 'Reserva la teva visita', text: 'Realitza el teu tractament amb nosaltres amb la tranquil·litat de rebre una atenció individualitzada.' },
            { title: 'Rep la teva factura', text: 'En acabar la sessió, t’entregarem la factura amb totes les dades necessàries.' },
            { title: 'Sol·licita el reemborsament', text: 'Presenta la factura a la teva asseguradora perquè gestioni el retorn de l’import que et correspongui.' },
          ],
        },
      },
  ...
  es: {
    ...
    pages: {
      ...
      prices: {
        title: 'Tarifas', subtitle: 'Precios claros y sin sorpresas.', note: 'Primera clase de pilates gratis.',
        insurance: {
          title: '¿Tienes una mutua con reembolso?',
          subtitle: 'Recupera hasta el 80% del coste de tu sesión de fisioterapia.',
          p1: 'En nuestra clínica no trabajamos directamente con mutuas, porque esto nos permite dedicar el tiempo necesario a cada paciente y ofrecer un tratamiento totalmente personalizado.',
          p2: 'Ahora bien, si tu póliza incluye reembolso de gastos o libre elección de profesionales, es muy probable que tu aseguradora te devuelva entre el 60% y el 80% del coste de la sesión (según las condiciones de tu mutua).',
          stepsTitle: '¿Cómo funciona?',
          steps: [
            { title: 'Comprueba tu póliza', text: 'Contacta con tu mutua y confirma que dispones de cobertura con reembolso o libre elección de profesionales.' },
            { title: 'Reserva tu visita', text: 'Realiza tu tratamiento con nosotros con la tranquilidad de recibir una atención individualizada.' },
            { title: 'Recibe tu factura', text: 'Al terminar la sesión, te entregaremos la factura con todos los datos necesarios.' },
            { title: 'Solicita el reembolso', text: 'Presenta la factura a tu aseguradora para que gestione la devolución del importe que te corresponda.' },
          ],
        },
      },
...
export const treatmentsList: Record<Lang, Treatment[]> = {
  ca: [
    ...
    { name: 'Fisioestètica', img: B + 'assets/tx2-fisioestetica.webp', text: 'La fisioestètica és una especialitat de la fisioteràpia que combina tècniques manuals i tecnologia avançada per millorar la salut i la qualitat dels teixits. Realitzem tractaments corporals i facials, com el lifting facial amb INDIBA®, que estimula la producció de col·lagen i elastina, millora la fermesa de la pell, redefineix l’oval facial i aporta un aspecte més lluminós i rejovenit de manera natural i no invasiva.' },
  ...
  es: [
    ...
    { name: 'Fisioestética', img: B + 'assets/tx2-fisioestetica.webp', text: 'La fisioestética es una especialidad de la fisioterapia que combina técnicas manuales y tecnología avanzada para mejorar la salud y la calidad de los tejidos. Realizamos tratamientos corporales y faciales, como el lifting facial con INDIBA®, que estimula la producción de colágeno y elastina, mejora la firmeza de la piel, redefine el óvalo facial y aporta un aspecto más luminoso y rejuvenecido de forma natural y no invasiva.' },
...
export const teamList: Record<Lang, TeamMember[]> = {
  ca: [
    ...
    { img: B + 'assets/team-LAIA-TEIXIDO.jpg', name: 'Laia Teixidó', role: 'Fisioterapeuta especialitzada en sòl pelvià', col: 'Col. 11.959', bullets: ['Fisioteràpia uroginecològica: postpart i disfuncions del sòl pelvià', 'Punció seca', 'Gimnàstica abdominal hipopressiva', 'Exercici terapèutic en l’embaràs', 'Mètode Pilates sòl', 'Ecografia musculoesquelètica'], bio: ['Amb més de 10 anys d’experiència en fisioteràpia del sòl pelvià, la Laia destaca per la seva proximitat, sensibilitat i vocació per cuidar. Creu en l’acompanyament individualitzat i en la importància d’escoltar cada pacient per oferir el millor tractament possible. La seva passió per aquesta especialitat la porta a formar-se contínuament per incorporar les tècniques i coneixements més actuals. T’acompanyarà amb confiança, professionalitat i empatia durant tot el teu embaràs, des del primer dia, i en qualsevol etapa de la teva salut pelviana.'] },
    { img: B + 'assets/team-raulSerra.webp', name: 'Raúl Serra', role: 'Especialista en teràpia manual', col: 'Col. 4212 (CFC)', bullets: ['+20 anys d’experiència', 'Disfuncions cràniomandibulars i ATM', 'Punció seca i dolor miofascial', 'Ones de xoc', 'Fisioteràpia i massatge esportiu'], bio: ['Amb més de 25 anys d’experiència en el món de la fisioteràpia, en Raúl és un professional amb una gran vocació per cuidar les persones. Especialista en teràpia manual i massoteràpia, destaca per les seves mans expertes i per la seva capacitat per tractar tota mena de dolors musculoesquelètics, especialment els problemes d’esquena. El seu tracte proper, la seva capacitat d’escolta i la seva dedicació fan que cada pacient se senti acompanyat i en bones mans durant tot el procés de recuperació.'] },
    { img: B + 'assets/team-Dylan-Koelma.webp', name: 'Dylan Koelma', role: 'Fisioterapeuta esportiu', col: 'Col. 17.166', bullets: ['Postgrau Expert en Diagnòstic Diferencial (2025)', 'Formació en Indiba Activ', 'Punció seca', 'Neuromodulació en patologia clínica', 'Especialista en exercici terapèutic'], bio: ['En Dylan és un fisioterapeuta esportiu apassionat pel moviment i el rendiment físic. Entén l’esport des de dins i treballa perquè cada pacient pugui recuperar-se amb seguretat i tornar a fer allò que més li agrada. La seva inquietud el porta a formar-se contínuament per oferir els tractaments més actuals.'] },
    { img: B + 'assets/team-guillem-armengol.jpg', name: 'Guillem Armengol Diego', role: 'Fisioterapeuta', col: 'Col. 17752', bullets: ['Grau en Fisioteràpia – Escoles Universitàries Gimbernat (UAB)', 'Màster en Readaptació Esportiva – Universitat Blanquerna (en curs)', 'Formació en Punció Seca', 'Formació en Thrust (manipulacions vertebrals i perifèriques)', 'Formació en Biomecànica del peu', 'Formació en Quiromassatge'], bio: ['En Guillem destaca per la seva implicació i pel seu enfocament actiu de la fisioteràpia. Amant de l’esport i de la readaptació, acompanya cada pacient amb proximitat i professionalitat, apostant sempre per una formació constant i basada en l’evidència científica.'] },
    { img: B + 'assets/team-marina-marti.jpg', name: 'Marina Martí Casado', role: 'Fisioterapeuta', col: 'Col. 17890', bullets: ['Grau en Fisioteràpia (Menció en Aparell Locomotor)', 'Postgrau en Fisioteràpia Invasiva (ecografia, neuromodulació, neuroeix i electròlisi)', 'Seminaris Travell & Simons – Punció seca', 'Indiba Academy: musculoesquelètic i dermatofuncional'], bio: ['La Marina viu la fisioteràpia amb entusiasme i dedicació. Especialitzada en l’àmbit esportiu, combina un tracte proper amb una actualització constant dels seus coneixements per ajudar cada pacient a recuperar-se, prevenir lesions i assolir els seus objectius.'] },
  ],
  es: [
    ...
    { img: B + 'assets/team-LAIA-TEIXIDO.jpg', name: 'Laia Teixidó', role: 'Fisioterapeuta especializada en suelo pélvico', col: 'Col. 11.959', bullets: ['Fisioterapia uroginecológica: postparto y disfunciones del suelo pélvico', 'Punción seca', 'Gimnasia abdominal hipopresiva', 'Ejercicio terapéutico en el embarazo', 'Método Pilates suelo', 'Ecografía musculoesquelética'], bio: ['Con más de 10 años de experiencia en fisioterapia del suelo pélvico, Laia destaca por su cercanía, sensibilidad y vocación por cuidar. Cree en el acompañamiento individualizado y en la importancia de escuchar a cada paciente para ofrecer el mejor tratamiento posible. Su pasión por esta especialidad la lleva a formarse continuamente para incorporar las técnicas y conocimientos más actuales. Te acompañará con confianza, profesionalidad y empatía durante todo tu embarazo, desde el primer día, y en cualquier etapa de tu salud pélvica.'] },
    { img: B + 'assets/team-raulSerra.webp', name: 'Raúl Serra', role: 'Especialista en terapia manual', col: 'Col. 4212 (CFC)', bullets: ['+20 años de experiencia', 'Disfunciones craneomandibulares y ATM', 'Punción seca y dolor miofascial', 'Ondas de choque', 'Fisioterapia y masaje deportivo'], bio: ['Con más de 25 años de experiencia en el mundo de la fisioterapia, Raúl es un profesional con una gran vocación por cuidar a las personas. Especialista en terapia manual y masoterapia, destaca por sus manos expertas y por su capacidad para tratar todo tipo de dolores musculoesqueléticos, especialmente los problemas de espalda. Su trato cercano, su capacidad de escucha y su dedicación hacen que cada paciente se sienta acompañado y en buenas manos durante todo el proceso de recuperación.'] },
    { img: B + 'assets/team-Dylan-Koelma.webp', name: 'Dylan Koelma', role: 'Fisioterapeuta deportivo', col: 'Col. 17.166', bullets: ['Posgrado Experto en Diagnóstico Diferencial (2025)', 'Formación en Indiba Activ', 'Punción seca', 'Neuromodulación en patología clínica', 'Especialista en ejercicio terapéutico'], bio: ['Dylan es un fisioterapeuta deportivo apasionado por el movimiento y el rendimiento físico. Entiende el deporte desde dentro y trabaja para que cada paciente pueda recuperarse con seguridad y volver a hacer aquello que más le gusta. Su inquietud le lleva a formarse continuamente para ofrecer los tratamientos más actuales.'] },
    { img: B + 'assets/team-guillem-armengol.jpg', name: 'Guillem Armengol Diego', role: 'Fisioterapeuta', col: 'Col. 17752', bullets: ['Grado en Fisioterapia – Escuelas Universitarias Gimbernat (UAB)', 'Máster en Readaptación Deportiva – Universidad Blanquerna (en curso)', 'Formación en Punción Seca', 'Formación en Thrust (manipulaciones vertebrales y periféricas)', 'Formación en Biomecánica del pie', 'Formación en Quiromasaje'], bio: ['Guillem destaca por su implicación y por su enfoque activo de la fisioterapia. Amante del deporte y de la readaptación, acompaña a cada paciente con cercanía y profesionalidad, apostando siempre por una formación constante y basada en la evidencia científica.'] },
    { img: B + 'assets/team-marina-marti.jpg', name: 'Marina Martí Casado', role: 'Fisioterapeuta', col: 'Col. 17890', bullets: ['Grado en Fisioterapia (Mención en Aparato Locomotor)', 'Posgrado en Fisioterapia Invasiva (ecografía, neuromodulación, neuroeje y electrólisis)', 'Seminarios Travell & Simons – Punción seca', 'Indiba Academy: musculoesquelético y dermatofuncional'], bio: ['Marina vive la fisioterapia con entusiasmo y dedicación. Especializada en el ámbito deportivo, combina un trato cercano con una actualización constante de sus conocimientos para ayudar a cada paciente a recuperarse, prevenir lesiones y alcanzar sus objetivos.'] },
  ],
};
