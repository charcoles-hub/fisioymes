...
export const treatmentsList: Record<Lang, Treatment[]> = {
  ca: [
    { name: 'Massatge terapèutic', img: B + 'assets/tx-massatge.jpg', text: 'El massatge és la nostra eina terapèutica més potent per tractar tot tipus de lesions musculars, tendinoses i lligamentoses. És completament personalitzat per a cada pacient. Realitzem massatge descontracturant, esportiu, relaxant i drenatge limfàtic manual.' },
    { name: 'Fisioteràpia esportiva', img: B + 'assets/tx-esportiva.jpg', text: 'Prevenció, tractament i rehabilitació de lesions en esportistes amb tècniques i exercicis específics per millorar força, flexibilitat i mobilitat, i optimitzar el rendiment.' },
    { name: 'Teràpia manual', img: B + 'assets/hero-carrusel2.jpg', text: 'Conjunt de tècniques aplicades amb les mans del fisioterapeuta per valorar, tractar i prevenir disfuncions musculoesquelètiques: mobilitzacions articulars, manipulacions i tècniques miofascials per modular el dolor, normalitzar el to muscular i millorar la mobilitat.' },
    { name: 'Radiofreqüència / Tecarteràpia', img: B + 'assets/clinic-gym.webp', text: 'Tecnologia que utilitza corrents d’alta freqüència per generar un augment controlat de temperatura als teixits profunds. Estimula la microcirculació, incrementa l’oxigenació cel·lular i afavoreix la reparació tissular. Indicada en lesions agudes i cròniques.' },
    { name: 'Tractament del sòl pèlvic', img: B + 'assets/lesion-SUELO-PELVICO.webp', text: 'Durant l’embaràs i el postpart cuidem el cos de la dona: alleugem molèsties com el mal d’esquena i la tensió pèlvica, preparem el cos per al part i treballem la recuperació del sòl pelvià i la faixa abdominal.' },
    { name: 'Ones de xoc', img: B + 'assets/lesion-TENDINOPATIAS.webp', text: 'Polsos acústics d’alta energia aplicats sobre la zona lesionada. Estimulen la circulació, promouen la regeneració cel·lular i ajuden a descompondre dipòsits de calci en tendons i lligaments. Indicades en tendinitis, fascitis plantar, epicondilitis, esperó calcani i contractures.' },
    { name: 'Magnetoteràpia', img: B + 'assets/lesion-REHAB.webp', text: 'Teràpia superinductiva basada en un camp electromagnètic d’alta intensitat. Alleuja el dolor, accelera la recuperació de fractures i edemes ossis, relaxa i estimula la musculatura i regenera el teixit, amb efecte neuromodulador.' },
    { name: 'Punció seca', img: B + 'assets/lesion-PUNTOS-GATILLOS.webp', text: 'Tècnica ràpida i efectiva en problemes musculars: actua sobre la placa motora del múscul i desencadena una reacció reflexa que baixa el to muscular. També tracta els punts gallet, causants de dolors referits.' },
    { name: 'Electròlisi percutània (EPTE)', img: B + 'assets/lesion-RADICULOPATIAS.webp', text: 'Tècnica revolucionària per al tractament de tendinopaties. Aplica microcorrents a través d’una agulla d’acupuntura, de manera pràcticament indolora, per accedir al teixit danyat i induir-ne l’autorecuperació, escurçant els temps de recuperació.' },
    { name: 'Ecografia', img: B + 'assets/lesion-HERNIA-DISCAL.webp', text: 'Eina avançada de diagnòstic que visualitza en temps real músculs, tendons i lligaments. Permet identificar l’origen de la lesió, valorar-ne l’abast, fer seguiment de l’evolució i guiar amb precisió tècniques invasives.' },
    { name: 'Hipopressius', img: B + 'assets/lesion-DRENAJE.webp', text: 'Tècnica d’entrenament que activa i enforteix el core i el sòl pelvià mitjançant postures específiques i respiració diafragmàtica. Millora la postura, redueix la cintura, prevé la incontinència urinària i millora el rendiment esportiu.' },
    { name: 'Articulació temporomandibular (ATM)', img: B + 'assets/lesion-ATM.webp', text: 'Tractament multifactorial de la disfunció de l’ATM (traumatismes, estrès, bruxisme, alteracions posturals) mitjançant treball postural de columna cervical i dorsal, teràpia manual i estiraments.' },
  ],
  es: [
    { name: 'Masaje terapéutico', img: B + 'assets/tx-massatge.jpg', text: 'El masaje es nuestra herramienta más potente para tratar lesiones musculares, tendinosas y ligamentosas. Totalmente personalizado: descontracturante, deportivo, relajante y drenaje linfático manual.' },
    { name: 'Fisioterapia deportiva', img: B + 'assets/tx-esportiva.jpg', text: 'Prevención, tratamiento y rehabilitación de lesiones en deportistas con técnicas y ejercicios específicos para mejorar fuerza, flexibilidad y movilidad, y optimizar el rendimiento.' },
    { name: 'Terapia manual', img: B + 'assets/hero-carrusel2.jpg', text: 'Conjunto de técnicas aplicadas con las manos del fisioterapeuta para valorar, tratar y prevenir disfunciones musculoesqueléticas: movilizaciones articulares, manipulaciones y técnicas miofasciales para modular el dolor, normalizar el tono muscular y mejorar la movilidad.' },
    { name: 'Radiofrecuencia / Tecarterapia', img: B + 'assets/clinic-gym.webp', text: 'Tecnología que utiliza corrientes de alta frecuencia para generar un aumento controlado de temperatura en los tejidos profundos. Estimula la microcirculación, incrementa la oxigenación celular y favorece la reparación tisular. Indicada en lesiones agudas y crónicas.' },
    { name: 'Tratamiento del suelo pélvico', img: B + 'assets/lesion-SUELO-PELVICO.webp', text: 'Durante el embarazo y el postparto cuidamos el cuerpo de la mujer: aliviamos molestias como el dolor de espalda y la tensión pélvica, preparamos el cuerpo para el parto y trabajamos la recuperación del suelo pélvico y la faja abdominal.' },
    { name: 'Ondas de choque', img: B + 'assets/lesion-TENDINOPATIAS.webp', text: 'Pulsos acústicos de alta energía aplicados sobre la zona lesionada. Estimulan la circulación, promueven la regeneración celular y ayudan a descomponer depósitos de calcio en tendones y ligamentos. Indicadas en tendinitis, fascitis plantar, epicondilitis, espolón calcáneo y contracturas.' },
    { name: 'Magnetoterapia', img: B + 'assets/lesion-REHAB.webp', text: 'Terapia superinductiva basada en un campo electromagnético de alta intensidad. Alivia el dolor, acelera la recuperación de fracturas y edemas óseos, relaja y estimula la musculatura y regenera el tejido, con efecto neuromodulador.' },
    { name: 'Punción seca', img: B + 'assets/lesion-PUNTOS-GATILLOS.webp', text: 'Técnica rápida y efectiva en problemas musculares: actúa sobre la placa motora del músculo y desencadena una reacción refleja que baja el tono muscular. También trata los puntos gatillo, causantes de dolores referidos.' },
    { name: 'Electrólisis percutánea (EPTE)', img: B + 'assets/lesion-RADICULOPATIAS.webp', text: 'Técnica revolucionaria para el tratamiento de tendinopatías. Aplica microcorrientes a través de una aguja de acupuntura, de forma prácticamente indolora, para acceder al tejido dañado e inducir su autorrecuperación, acortando los tiempos de recuperación.' },
    { name: 'Ecografía', img: B + 'assets/lesion-HERNIA-DISCAL.webp', text: 'Herramienta avanzada de diagnóstico que visualiza en tiempo real músculos, tendones y ligamentos. Permite identificar el origen de la lesión, valorar su alcance, hacer seguimiento de la evolución y guiar con precisión técnicas invasivas.' },
    { name: 'Hipopresivos', img: B + 'assets/lesion-DRENAJE.webp', text: 'Técnica de entrenamiento que activa y fortalece el core y el suelo pélvico mediante posturas específicas y respiración diafragmática. Mejora la postura, reduce la cintura, previene la incontinencia urinaria y mejora el rendimiento deportivo.' },
    { name: 'Articulación temporomandibular (ATM)', img: B + 'assets/lesion-ATM.webp', text: 'Tratamiento multifactorial de la disfunción de la ATM (traumatismos, estrés, bruxismo, alteraciones posturales) mediante trabajo postural de columna cervical y dorsal, terapia manual y estiramientos.' },
  ],
};
...
export const teamList: Record<Lang, TeamMember[]> = {
  ca: [
    ...
    { img: B + 'assets/team-RODRIGO-EVANGELISTI.jpg', name: 'Rodrigo Evangelisti', role: 'Director i fundador', col: 'Col. 12.352', bullets: ['Fisioterapeuta del primer equip del FC Dinamo de Bucarest', 'Ex-fisioterapeuta de l’Atlético de Madrid femení', 'EPTE – Electròlisi Percutània', 'Punció seca', 'Ecografia musculoesquelètica'] },
    ...
    { img: B + 'assets/team-LAIA-COSTA.jpg', name: 'Laia Costa', role: 'Fisioterapeuta esportiva', col: 'Col. 13.561', bullets: ['Menció en aparell locomotor', 'Tècniques manipulatives i miotensives (CAR Sant Cugat)', 'Nutrició aplicada a patologies musculoesquelètiques', 'Readaptació esportiva a peu de camp', 'Ecografia musculoesquelètica'] },
  ...
  es: [
    ...
    { img: B + 'assets/team-RODRIGO-EVANGELISTI.jpg', name: 'Rodrigo Evangelisti', role: 'Director y fundador', col: 'Col. 12.352', bullets: ['Fisioterapeuta del primer equipo del FC Dinamo de Bucarest', 'Ex-fisioterapeuta del Atlético de Madrid femenino', 'EPTE – Electrólisis Percutánea', 'Punción seca', 'Ecografía musculoesquelética'] },
    ...
    { img: B + 'assets/team-LAIA-COSTA.jpg', name: 'Laia Costa', role: 'Fisioterapeuta deportiva', col: 'Col. 13.561', bullets: ['Mención en aparato locomotor', 'Técnicas manipulativas y miotensivas (CAR Sant Cugat)', 'Nutrición aplicada a patologías musculoesqueléticas', 'Readaptación deportiva a pie de campo', 'Ecografía musculoesquelética'] },
...
export const pricesTables: Record<Lang, PriceTable[]> = {
  ca: [
    ...
    { title: 'Pilates individual', rows: [ { label: '1 classe/setmana', value: '45 €/classe' }, { label: '2 classes/setmana', value: '70 €/classe' } ] },
  ],
  es: [
    ...
    { title: 'Pilates individual', rows: [ { label: '1 clase/semana', value: '45 €/clase' }, { label: '2 clases/semana', value: '70 €/clase' } ] },
  ],
};
